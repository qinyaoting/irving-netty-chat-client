package com.irving.netty.chat.adapter;
 ...
 * @author luojun
 * @version 1.0.0
 * @ClassName AdapterChatMessage
 * @Description 聊天消息适配器
 * @createTime 2021/11/16 2:11
 */
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if (view == null) {
            ...
            if (isMeSend == 0) {//对方发送
                ...
                view = inflater.inflate(R.layout.item_system_receive_text, viewGroup, false);
                holder.tv_content = view.findViewById(R.id.system_chat_content);
                holder.tv_sendtime = view.findViewById(R.id.system_chat_sendtime);
            }
